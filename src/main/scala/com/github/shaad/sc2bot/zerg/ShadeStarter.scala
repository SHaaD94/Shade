...
import com.github.ocraft.s2client.protocol.game.{AiBuild, BattlenetMap, Difficulty, Race}
...
object ShadeStarter extends App {
  ...
  val s2Coordinator = S2Coordinator.setup
    ...
    .setParticipants(S2Coordinator.createParticipant(Race.ZERG, bot),
      ...
      S2Coordinator.createComputer(Race.TERRAN, Difficulty.EASY, AiBuild.MACRO))
    .launchStarcraft
